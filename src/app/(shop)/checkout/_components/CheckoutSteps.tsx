...
export default function CheckoutSteps({
  ...
  return (
    <div className="relative pt-6 pb-5 md:pt-8 md:pb-10">
      <div className="absolute left-0 right-0 top-[19px] md:top-6 h-[2px] bg-neutral-200" />

      <div
        className="absolute left-0 top-[19px] md:top-6 h-[2px] bg-black transition-all"
        style={{ width: `${progress}%` }}
      />

      <div className="relative flex items-start justify-between pt-[3px] md:pt-0">
        {STEP_LIST.map((s, i) => {
          ...
          return (
            ...
            >
              <div className="relative z-10 bg-white px-1.5 py-[1px]">

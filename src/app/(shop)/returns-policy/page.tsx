...
const RETURNS_POLICY_URL = `${SITE_ORIGIN}/returns-policy`;

const MERCHANT_RETURN_POLICY_ID = `${RETURNS_POLICY_URL}#merchant-return-policy`;
...
/**
 * Google MerchantReturnPolicy structured data.
 *
 * 这里使用 merchantReturnLink，而不声明所有退货均允许或均不允许。
 * 完整规则由页面正文说明，包括：
 * - 不接受普通 change-of-mind 退货；
 * - 保留适用消费者法律下的瑕疵商品权利。
 */
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: serializeJsonLd(merchantReturnPolicyJsonLd),
        }}
      />
        ...
        intro={
          <>
            ...
            <p>
              ...
              within <strong>{checkoutRegionLabel}</strong>. Orders placed
              through this storefront are intended for customers with delivery
              addresses in that region only.
            </p>
            <p>
            ...
            <p>
              ...
              applicable consumer law in <strong>{legalRegionLabel}</strong>,
              including any mandatory cancellation, withdrawal, refund,
              replacement, or repair rights that may apply to eligible
              purchases.
            </p>
          </>
        }
      >
        <section>
          ...
          <p>
            Any exception to this position may be made only if we choose to do
            so in writing, in our sole discretion, and on terms determined by
            us.
          </p>
          <p>
          ...
          <p>
            ...
            replacement right, refund right, or other remedy that may apply
            under the law governing the relevant purchase.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            These conditions apply only to a discretionary change-of-mind
            return. They do not apply where you are seeking a remedy for goods
            that are faulty, damaged, incorrect, not as described, or otherwise
            fail to meet rights that cannot lawfully be excluded. Original
            packaging is not required to exercise those rights.
          </p>
          <p>
            Final sale, clearance, promotional, personalised, or
            hygiene-sensitive items are not eligible for discretionary
            change-of-mind returns unless we expressly agree otherwise in
            writing. This does not limit any non-excludable rights or remedies
        ...
        <section>
          ...
          <p>
            We may ask for reasonable supporting information, including your
            order number, a description of the issue, and photos of the item and
            packaging, so that we can assess the claim efficiently and provide
        ...
        <section>
          ...
          <p>
            To request a return, refund, replacement, or other after-sales
            review, please use the return request process available on our
            website or contact our returns support contact using the details set
            out below.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              the reason for the request, including photos where relevant.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            If we confirm that an item is faulty, damaged, incorrect, or
            otherwise eligible for a remedy under applicable law, we will
            provide an appropriate return arrangement where required by law.
            This may include a prepaid return label, reimbursement of reasonable
            return postage you have paid, or another suitable return method.
            Please keep any postage or transport receipt so that eligible
            reasonable return costs can be reimbursed.
          </p>
          <p>
            Depending on the storefront and the jurisdiction involved, return
            shipping instructions, the party responsible for return shipping
            cost, and any requirement to use an approved return method may vary
        ...
        {isAu ? (
          <section>
            ...
            <p>
              ...
              entitled to have the item repaired, replaced, or otherwise
              remedied within a reasonable time in accordance with applicable
              law.
            </p>
            <p>
              Nothing in this Returns Policy is intended to exclude, restrict,
              or modify any rights or remedies that cannot lawfully be excluded
          ...
          <section>
            ...
            <p>
              For customers using this New Zealand storefront, your rights may
              be affected by the Consumer Guarantees Act 1993, the Fair Trading
              Act 1986, and other applicable New Zealand laws.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Where applicable, eligible customers may have a withdrawal period
              of <strong>14 days</strong> from delivery or, where relevant, from
              the conclusion of the contract, subject to the nature of the
              goods, whether the purchase is eligible, and any lawful exceptions
            ...
            <p>
              ...
              of the returned goods may affect the amount refundable where this
              is permitted by law.
            </p>
            <p>
              ...
              differently. This policy should be read together with any
              mandatory rights that apply in the relevant European destination.
            </p>
          </section>
        ) : isUs ? (
          <section>
            ...
            <p>
              Change-of-mind returns under our discretionary commercial policy
              are separate from any mandatory legal rights or remedies that may
              apply under the law of the relevant jurisdiction.
            </p>
            <p>
              Where goods arrive faulty, damaged, incorrect, or materially not
              as described, you may be entitled to an appropriate remedy under
              applicable law, and we may provide additional
              jurisdiction-specific notices or instructions where required.
            </p>
            <p>
              Depending on the law that applies, refund timing, available remedy
              options, and any conditions for rejecting, limiting, or reviewing
              a return or refund request may vary between jurisdictions.
            </p>
          </section>
        ) : isCa ? (
          <section>
            ...
            <p>
              Change-of-mind returns under our discretionary commercial policy
              are separate from any mandatory legal rights or remedies that may
              apply under the law of the relevant province, territory, or other
            ...
            <p>
              Depending on the law that applies, refund timing, available remedy
              options, and any conditions for rejecting, limiting, or reviewing
              a return or refund request may vary between provinces or
              territories.
            </p>
          </section>
        ) : (
          <section>
            ...
            <p>
              ...
              depending on the country or region served by this storefront and
              the laws that apply to that transaction.
            </p>
            <p>
        ...
        <section>
          ...
          <p>
            If a refund is approved, it will generally be issued to your
            original payment method unless another method is required by law or
          ...
          <p>
            ...
            refund basis, including whether the refund arises from a
            discretionary change-of-mind return, a statutory withdrawal right,
            or a fault-based remedy.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            damage, abnormal wear and tear, unauthorised modification, failure
            to follow care instructions, or insufficient evidence of the claimed
            issue.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            return, refund, cancellation, or complaint-handling information
            where required.
          </p>
